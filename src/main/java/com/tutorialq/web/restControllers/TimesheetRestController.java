...
public class TimesheetRestController {
    ...
    public ResponseEntity<Timesheet> getTimesheetByEndDate(
		...
		/*
		 * log.
		 * info("Inside getTimesheetByEndDate method of TimesheetRestController:: endDate: "
		 * + endDate + "employeeId: " + employeeId);
		 */
        try {
    ...
    public ResponseEntity<Timesheet> getTimesheetSummaryStaff(
		...
		/*
		 * log.
		 * info("Inside getTimesheetSummaryStaff method of Timesheet Rest Controller:: fromDate: "
		 * + fromDate + " toDate: " + toDate + " timesheetStatus: " + timesheetStatus);
		 */        try {
    ...
    public ResponseEntity<RestResponseEntity> approveTimesheet(
		...
		/*
		 * log.
		 * info("Inside approveTimesheet method of TimesheetRestController:: timesheetId: "
		 * + timesheetId + "reviewerName: " + reviewerName + " reviewComments: " +
		 * reviewComments);
		 */
        try {
            Timesheet timesheetObj = timesheetService.getTimesheetByTimesheetId(timesheetId);
			...
			/*
			 * restResponseEntity = new
			 * RestResponseEntity(ApplicationConstants.REST_RESPONSE_CODE_SUCCESS,
			 * "Selected Timesheet Approved Successfully!!", "alert-success");
			 */
        } catch (Exception ex) {
			/*
			 * log.error("Exception while Approving Timesheet: " + ex); restResponseEntity =
			 * new RestResponseEntity(ApplicationConstants.REST_RESPONSE_CODE_ERROR,
    ...
    public ResponseEntity<RestResponseEntity> rejectTimesheet(
		...
		/*
		 * log.
		 * info("Inside rejectTimesheet method of TimesheetRestController:: timesheetId: "
		 * + timesheetId + "reviewerName: " + reviewerName + " reviewComments: " +
		 * reviewComments);
		 */
        try {
			 ...
			 * restResponseEntity = new
			 * RestResponseEntity(ApplicationConstants.REST_RESPONSE_CODE_ERROR,
